...
export function GridBackgroundDemo() {
  return (
    ...
    "dark:[background-image:linear-gradient(to_right,#262626_1px,transparent_1px),linear-gradient(to_bottom,#262626_1px,transparent_1px)]"
      ...
      <p
        className="relative z-20 bg-gradient-to-b from-neutral-200 to-neutral-500 bg-clip-text py-8 text-4xl font-bold text-transparent sm:text-7xl font-major-mono-display">
        Amith Gamagedara
      </p>
    </div>
  );
